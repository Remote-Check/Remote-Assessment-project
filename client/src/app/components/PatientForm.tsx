          ...
          >
            ...
            <fieldset>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                <div>
                  <label htmlFor="birth-day" className="sr-only">יום הולדת (יום)</label>
                  <input
                    id="birth-day"
                    value={birthDay}
                ...
                <div>
                  <label htmlFor="birth-month" className="sr-only">חודש הולדת (חודש)</label>
                  <input
                    id="birth-month"
                    value={birthMonth}
                ...
                <div>
                  <label htmlFor="birth-year" className="sr-only">שנת הולדת (שנה)</label>
                  <input
                    id="birth-year"
                    value={birthYear}
