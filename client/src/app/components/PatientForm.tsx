          ...
          >
            ...
            <fieldset>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                <div>
                  <label htmlFor="birthDay" className="sr-only">יום הלידה</label>
                  <input
                    id="birthDay"
                    value={birthDay}
                ...
                <div>
                  <label htmlFor="birthMonth" className="sr-only">חודש הלידה</label>
                  <input
                    id="birthMonth"
                    value={birthMonth}
                ...
                <div>
                  <label htmlFor="birthYear" className="sr-only">שנת הלידה</label>
                  <input
                    id="birthYear"
                    value={birthYear}
