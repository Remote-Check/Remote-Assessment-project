    ...
    >
      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
          ...
          >
            <div>
              <label htmlFor="caseId" className="block text-sm font-bold text-gray-600 mb-1">
                מזהה תיק*
              </label>
              <input
                id="caseId"
            ...
            <div>
              <label htmlFor="phone" className="block text-sm font-bold text-gray-600 mb-1">
                טלפון*
              </label>
              <input
                id="phone"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label htmlFor="gender" className="block text-sm font-bold text-gray-600 mb-1">
                  מין*
                </label>
                <select
                  id="gender"
              ...
              <div>
                <label htmlFor="language" className="block text-sm font-bold text-gray-600 mb-1">
                  שפת המבדק*
                </label>
                <select
                  id="language"
