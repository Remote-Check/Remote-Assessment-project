      ...
      >
        ...
        <form onSubmit={handleSubmit} className="flex min-h-0 flex-1 flex-col">
          ...
          >
            ...
            <div>
              <label htmlFor="patient-phone" className="block text-sm font-bold text-gray-600 mb-1">
                טלפון*
              </label>
              <input
                id="patient-phone"
            ...
            <fieldset>
              ...
              <div className="grid grid-cols-3 gap-2 sm:gap-3">
                <div>
                  <label htmlFor="patient-birthDay" className="sr-only">
                    יום הולדת
                  </label>
                  <input
                    id="patient-birthDay"
                ...
                <div>
                  <label htmlFor="patient-birthMonth" className="sr-only">
                    חודש הולדת
                  </label>
                  <input
                    id="patient-birthMonth"
                    value={birthMonth}
                ...
                <div>
                  <label htmlFor="patient-birthYear" className="sr-only">
                    שנת הולדת
                  </label>
                  <input
                    id="patient-birthYear"
                    value={birthYear}
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <label
                  htmlFor="patient-dominantHand"
                  className="block text-sm font-bold text-gray-600 mb-1"
                >
                  יד דומיננטית*
                </label>
                <select
                  id="patient-dominantHand"
                  value={dominantHand}
                  onChange={(e) =>
              ...
              <div>
                <label
                  htmlFor="patient-educationYears"
                  className="block text-sm font-bold text-gray-600 mb-1"
                >
                  שנות לימוד*
                </label>
                <input
                  id="patient-educationYears"
